...
def part1(cards: dict[int, tuple[list[str], list[str]]]):
    s = 0
...
def part2(cards: dict[int, tuple[list[str], list[str]]]):
    to_scratch = {
        card_id: 1
    ...
    print(sum(scratched.values()))


if __name__ == "__main__":
    inp = get_input("day4-input.txt")
    part2(inp)
